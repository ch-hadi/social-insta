...
const Sidebar = () => {
  ...
  return (
    <>
      {show ? (
        // <div className='w-full flex justify-center  h-[100%] bg-purple-100 fixed rounded '>
        <CModal open={show} handleClose={handleCreate} setOpen={setShow} />
      ) : (
        // </div>
        ''
      )}
      <div className='pt-10 ml-5 fixed'>
